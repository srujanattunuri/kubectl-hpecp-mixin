...
const (
	mixinName    = "kubectlhpecp"
	mixinPackage = "github.com/srujanattunuri/kubectl-hpecp-mixin"
...
func Publish() {
	...
	if _, overridden := os.LookupEnv(releases.ReleaseRepository); !overridden {
		os.Setenv(releases.ReleaseRepository, "github.com/srujanattunuri/kubectl-hpecp-mixin")
	}
